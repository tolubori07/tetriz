...
// Matrices
const grid: GridSquare[GRID_HORIZONTAL_SIZE][GRID_VERTICAL_SIZE] = undefined;
const piece: GridSquare[4][4] = undefined;
const incomingPiece: GridSquare[4][4] = undefined;

//track active piece position
var piecePositionX: i32 = 0;
var piecePositionY: i32 = 0;
...
fn Createpiece() bool {
    ...
    for (piecePositionX..piecePositionX + 4) |i| {
        for (0..4) |j| {
            if (piece[i - @as(i32, piecePositionX)][j] == GridSquare.moving) grid[i][j] = GridSquare.moving;
        }
    }
